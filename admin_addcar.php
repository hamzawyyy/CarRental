  ...
  <body>
    ...
    <nav>
        ...
        <a> Welcome <?php echo $_SESSION['admin_name']; ?></a>
           <li><a href="admin_addcar.php">ADD CAR</a></li>
          <li><a href="admin_addcar.php">ADD OFFICE</a></li>
          <li><a href="admin_addcar.php">UPDATE CAR</a></li>
...
<?php
$show_cars = $conn->prepare("SELECT * FROM `car`");
$show_cars->execute();
$result = $show_cars->get_result();
...
?>
    <div class="box">
        ...
        <div class="flex-btn">
            <a href="admin_update_car.php?update=<?= $fetch_car['Car_plate']; ?>" class="btn">Update</a>
